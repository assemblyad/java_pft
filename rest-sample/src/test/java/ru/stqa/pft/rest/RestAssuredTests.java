...
public class RestAssuredTests {
  ...
  @BeforeClass
  public void init(){
    RestAssured.authentication = RestAssured.basic("2d81ba95abcbc53e43e945dcb4d48e77","");
  }
  ...
  public void testCreateIssue() throws IOException {
    ...
    Issue newIssue = new Issue().withSubject("Test me now issue 1234").withDescription("New test me now Issue 1234");
  ...
  public void testTestExecutionWithResolvedIssue(){
    skipIfNotFixed(6655);
    System.out.println("Test executed and issue # fixed :" + 6655);
  }
  @Test(enabled = true)
  public void testTestExecutionWithNoTResolvedIssue(){
    skipIfNotFixed(6654);
    System.out.println("Test executed and issue # fixed :" + 6654);
  }
  //
